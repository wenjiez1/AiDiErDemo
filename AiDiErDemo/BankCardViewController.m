...
//    [mDeviceMgr setBankServerPort:5201];
    ...
    [mDeviceMgr setBankServerIP:@"ipos.chinaums.com"];
    [mDeviceMgr setBankServerPort:9210];
    [mDeviceMgr setCertificateType:ConnectionModeDebug];
    
//    [mDeviceMgr setBankServerIP:@"upos.chinaums.com"];
//    [mDeviceMgr setBankServerPort:16601];
//    [mDeviceMgr setCertificateType:ConnectionModeProduct];
